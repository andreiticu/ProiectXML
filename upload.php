...
<div id="content">
    <form method="post" action="save.php" enctype="multipart/form-data">
        <table align="center">
            ...
            <tr><td>ID:<input type="text" size="20" name="id"></td></tr>
                           <tr><td> <input type="file" name="image"></td></tr>
                            <tr><td><textarea name="text" cols="40" rows="4" placeholder="name of image"></textarea></td></tr>
                           <tr><td> <input class="btn btn-default btn-lg" type="submit" name="upload" value="Upload Image"></td></tr>
        </table>     
            </form>
</div>
</center>
