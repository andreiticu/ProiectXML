...
<div class="container-fluid bg-1 text-center">
  <img src="image//logo.png" class="img-responsive margin" style="display:inline" alt="Bird" width="500" height="500">
       <script>function anti_right()
	{
	alert('Nu poți efectua alte operațiuni în această pagină!');

	return(false);
	}
document.oncontextmenu = anti_right;</script>
  <center>
<video width="1200" height="800" controls>
    <source src="image/paste.mp4" type="video/mp4">
    <source src="image/paste.ogg" type="video/ogg">
</video>
</center>
</div>
